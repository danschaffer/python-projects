...
def food_of_day(month=None, day=None):
    ...
    return {
        ...
        (1,6): "National Shortbread Day / National Bean Day",
        (1,7): "National Tempura Day / Fruitcake Toss Day",
        ...
        (1,15): "National Strawberry Ice Cream Day / National Fresh Squeezed Juice Day",
        (1,16): "National Fig Newton Day / International Hot and Spicy Food Day",
        ...
        (4,12): "National Licorice Day / Grilled Cheese Sandwich Day",
